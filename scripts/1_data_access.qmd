...
```{bash}
mc cp s3/oidc-vsonnet/Global_POC_Database_2025-07-01.csv ~/work/PSDtoCarbonExport-short/data
```
...
If needed: Cephaloplot

```{r}
cd ../functions
# clone only the lastest commit snapshot 
git clone --depth 1 https://github.com/VirginieSonnet/Cephaloplot.git
# remove the git file to have it as a regular folder
rm -rf Cephaloplot/.git
```
