...
Note: this QC needs to take into account the number of classes left (i.e. 3 classes, especially the first ones will focus on the small bell shape at the beginning rather than the whole spectra shape)
...
uvppart <- uvppart %>%
  ...
  group_by(psampleid,dbname,geometric_mean) %>% 
